          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                This Policy describes how we treat personal information on the websites and apps where it is located. Your use of this website indicates that you agree to our collection, disclosure, use, of your information as described in this Privacy Policy. This includes Assurifii&apos;s auto, home and life insurance services as well as all services marketed and provided by Assurifii.com. It also applies to our mobile sites and apps.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              If you have any questions about this Policy, please email us at <a href="mailto:contact@assurifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@assurifii.com</a>.
              </p>
